 ...
 *
 * @author : loey
 * @className : TMovieWithRemovingTvEntity
 * @since : 2021-12-10 21:40
 **/
@Entity
@Table(name = "t_movie_with_removing_TV", schema = "data_warehouse", catalog = "")
public class TMovieWithRemovingTvEntity {
    private String asin;
    ...
    private String nearAsin;
    private Integer commentNum;
    private Double dbRaringScore;
    ...
    @Basic
    @Column(name = "movie_release_date", nullable = true, length = 255)
    ...
    @Basic
    @Column(name = "near_asin", nullable = true, length = 255)
    public String getNearAsin() {
        return nearAsin;
    }

    public void setNearAsin(String nearAsin) {
        this.nearAsin = nearAsin;
    }
    ...
    @Basic
    @Column(name = "db_raring_score", nullable = true, precision = 0)
    public Double getDbRaringScore() {
        return dbRaringScore;
    }

    public void setDbRaringScore(Double dbRaringScore) {
    ...
    public boolean equals(Object o) {
        ...
        TMovieWithRemovingTvEntity that = (TMovieWithRemovingTvEntity) o;
        ...
        if (movieReleaseDate != null ? !movieReleaseDate.equals(that.movieReleaseDate) : that.movieReleaseDate != null)
            return false;
        if (nearAsin != null ? !nearAsin.equals(that.nearAsin) : that.nearAsin != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (nearAsin != null ? nearAsin.hashCode() : 0);
