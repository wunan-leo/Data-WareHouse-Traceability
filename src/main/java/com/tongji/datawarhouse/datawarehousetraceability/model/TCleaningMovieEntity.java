 ...
 *
 * @author : loey
 * @className : TCleaningMovieEntity
 * @since : 2021-12-10 21:39
 **/
@Entity
@Table(name = "t_cleaning_movie", schema = "data_warehouse", catalog = "")
public class TCleaningMovieEntity {
    private String asin;
    ...
    public boolean equals(Object o) {
        ...
        TCleaningMovieEntity that = (TCleaningMovieEntity) o;
